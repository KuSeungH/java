...
class LRandomGUI2 extends Frame implements ActionListener{/////////////
    ...
    public LRandomGUI2(){
        ...
        tf1.setFont(new Font("굴림",Font.BOLD,25));
        ...
        tf2.setFont(new Font("굴림",Font.BOLD,25));
        ...
        tf3.setFont(new Font("굴림",Font.BOLD,25));
        ...
        tf4.setFont(new Font("굴림",Font.BOLD,25));
        ...
        tf5.setFont(new Font("굴림",Font.BOLD,25));
        ...
        tf6.setFont(new Font("굴림",Font.BOLD,25));
